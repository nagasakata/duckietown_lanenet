...
def test_lanenet(raw_image,
    ...
    #binary_seg_ret, instance_seg_ret = net.inference(input_tensor=input_tensor, name='LaneNet', reuse=tf.compat.v1.AUTO_REUSE)
...
if __name__ == '__main__':
    ...
    #test_lanenet(with_lane_fit=args.with_lane_fit)
